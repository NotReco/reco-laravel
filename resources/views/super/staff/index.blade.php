<x-superadmin-layout title="Tài khoản Staff" pageTitle="Quản lý tài khoản Staff & Admin">
    ...
    <div
        ...
        <div>
            ...
            <p class="text-amber-300/80 mt-0.5">Tài khoản Staff và Admin có quyền truy cập Control Panel. Mọi thay đổi
                ...
                <tbody class="divide-y divide-dark-800">
                    @forelse($staffAccounts as $account)
                        <tr
                            ...
                            <td class="px-5 py-3">
                                <span
                                    class="badge text-[10px] bg-{{ $account->role->color() }}-500/20 text-{{ $account->role->color() }}-400">
                                    {{ $account->role->label() }}
                                </span>
                            </td>
                    ...
                    @empty
                        <tr>
                            <td colspan="6" class="px-5 py-12 text-center text-dark-500">Chưa có tài khoản Staff
                                nào.</td>
                        </tr>
                    @endforelse
                </tbody>
