<x-guest-layout>
    <x-slot:title>Xác nhận mật khẩu</x-slot:title>

    <div class="space-y-8">
        {{-- Header --}}
        <div class="text-center">
            <h2 class="text-[22px] font-bold text-gray-900">Xác nhận mật khẩu</h2>
        </div>

        {{-- Description --}}
        <div class="bg-gray-50 border border-gray-200 rounded-xl p-4 text-center">
            <p class="text-[14px] leading-relaxed text-gray-600">
                Đây là khu vực bảo mật của ứng dụng. Vui lòng xác nhận lại mật khẩu của bạn trước khi tiếp tục thực hiện hành động này.
            </p>
        </div>
        ...
        <form method="POST" action="{{ route('password.confirm') }}" class="space-y-5">
            ...
            <div x-data="{ show: false }">
                <label for="password" class="block text-sm font-semibold text-gray-700 mb-1.5">Mật khẩu của bạn</label>
                <div class="relative">
                    <input id="password" :type="show ? 'text' : 'password'" name="password"
                        ...
                        placeholder="Nhập mật khẩu hiện tại" required autocomplete="current-password" autofocus>
