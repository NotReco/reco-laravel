<x-app-layout>
    <x-slot:title>Khám phá phim lẻ</x-slot:title>
        ...
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8" x-data="exploreFilter()" @popstate.window="handlePopstate">
            ...
            <div class="flex flex-col lg:flex-row gap-8">
                ...
                <div class="w-full lg:w-72 flex-shrink-0">
                    ...
                    <form action="{{ route('explore') }}" method="GET" id="explore-filter-form" class="space-y-4"
                            ...
                            <div x-data="{ open: true }">
                                ...
                                <div x-show="open" x-collapse>
                                    <div class="px-5 pb-5 pt-1 space-y-5">
                                        ...
                                        {{-- Runtime --}}
                                        <div>
                                            <label class="block text-sm font-medium text-gray-900 mb-3">Thời lượng
                                                (phút)</label>
                                            <div class="flex items-center gap-2">
