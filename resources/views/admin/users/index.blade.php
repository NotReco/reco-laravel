    ...
    <div class="overflow-x-auto">
        <table class="w-full text-sm">
            ...
            <tbody class="divide-y divide-dark-800">
                            ...
                            <div class="flex items-center justify-end gap-1">
                                ...
                                @if($user->id !== auth()->id())
                                    <form action="{{ route('admin.users.toggleBan', $user) }}" method="POST"
                                        ...
                                        @csrf
                                        <button type="submit" class="text-dark-400 hover:text-{{ $user->is_active ? 'red' : 'emerald' }}-400 transition-colors p-1"
                ...
                @empty
                    <tr>
                        <td colspan="6" class="px-5 py-12 text-center text-dark-500">Không tìm thấy user nào.</td>
                    </tr>
                @endforelse
            </tbody>
        </table>
