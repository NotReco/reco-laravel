                ...
                <tbody class="divide-y divide-dark-800">
                    @forelse ($frames as $frame)
                        <tr class="hover:bg-dark-800/30 transition-colors">
                            <td class="px-6 py-4">
                                <div
                                    class="w-16 h-16 bg-dark-800 rounded flex items-center justify-center p-1 border border-dark-700">
                            ...
                            <td class="px-6 py-4 text-center">
                                ...
                                @else
                                    <span
                                        class="inline-flex items-center px-2 py-0.5 rounded text-xs font-medium bg-red-500/10 text-red-400 border border-red-500/20">
                                        Ẩn
                                    </span>
                                @endif
                            </td>
