...
>
    @if(session('success'))
        <div class="flex items-center gap-3 px-5 py-4 bg-dark-800 border border-green-500/30 rounded-xl shadow-xl backdrop-blur-sm">
    ...
    @if(session('error'))
        <div class="flex items-center gap-3 px-5 py-4 bg-dark-800 border border-red-500/30 rounded-xl shadow-xl backdrop-blur-sm">
    ...
    @if(session('info'))
        <div class="flex items-center gap-3 px-5 py-4 bg-dark-800 border border-blue-500/30 rounded-xl shadow-xl backdrop-blur-sm">
